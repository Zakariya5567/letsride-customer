...
class ApiClient extends GetxService {
  ...
  Future<Response> deleteData(String uri, {Map<String, String> headers}) async {
    ...
    String customerId= sharedPreferences.getInt("customer_id").toString();

    print("customer is id =====>>>>: $customerId");
    Map data={"customer_id":customerId};
    print("sending data is ${data}");

    print('======>>>MainHeader: $_mainHeaders.');
    String token=_mainHeaders['Authorization'];
    ...
    try {
      ...
      Http.Response _response = await Http.post(
        Uri.parse(appBaseUrl+uri),body: {"customer_id":customerId},
