...
class AppConstants {
  static const String APP_NAME = 'Lets Ride';
  static const double APP_VERSION = 5.6;
  static const String BASE_URL = 'http://admin.letsride.today';
  // static const String BASE_URL = 'http://letsride.today';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String DRIVER_REMOVE = '/api/v1/customer/remove-customer-account';
