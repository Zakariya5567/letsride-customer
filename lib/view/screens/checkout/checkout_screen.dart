...
// restaurant closed       
                ...
                if (restController.restaurant != null) {
                  _todayClosed = restController.isRestaurantClosed(true,
                      restController.restaurant.active,restController.restaurant.schedules);

                  _tomorrowClosed = restController.isRestaurantClosed( false,
                      restController.restaurant.active, restController.restaurant.schedules);
                                    ...
                                    ? CustomButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          if (!_isCashOnDeliveryActive &&
                                            ...
                                            showCustomSnackBar('Enter postal code first');
                                          }
