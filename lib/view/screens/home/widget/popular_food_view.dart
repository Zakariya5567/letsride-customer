...
//=====================================================================================                    
                         ...
                         isPopular?productController.popularProductList[index].halal==1?
                          Positioned(
                            top: Dimensions.PADDING_SIZE_EXTRA_SMALL,left: 2,
                                child: Image.asset(Images.halal_image,scale: 12,)
                          ):SizedBox()
                          
                          :productController.reviewedProductList[index].halal==1?
                          Positioned(
                            top: Dimensions.PADDING_SIZE_EXTRA_SMALL,left: 2,
                                child: Image.asset(Images.halal_image,scale: 12,)
                          ):SizedBox()
