...
//=====================================================================================                    
                       isPopular? restController.popularRestaurantList[index].halal==1?
                          Positioned(
                            bottom: Dimensions.PADDING_SIZE_EXTRA_SMALL,left: 5,

                                child: Image.asset(Images.halal_image,scale: 8,)

                          )
                          :SizedBox()
                          :restController.latestRestaurantList[index].halal==1?
                             Positioned(
                            bottom: Dimensions.PADDING_SIZE_EXTRA_SMALL,left: 5,
