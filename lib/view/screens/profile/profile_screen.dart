          ...
          mainWidget: SingleChildScrollView(physics: BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              ProfileButton(icon: Icons.support_agent,title: 'Support'.tr, onTap: () async{
                ...
                sharedPreferences.setInt("user_id", userController.userInfoModel.id);
                int userId= sharedPreferences.getInt("user_id");

                String url="${AppConstants.docUrl}${userController.userInfoModel.id}";

                print("Documnet url is =====>>>>> ${url}");

                String image= '${Get.find<SplashController>().configModel.baseUrls.customerImageUrl}'
                    '/${(userController.userInfoModel != null && _isLoggedIn) ? userController.userInfoModel.image : ''}';

                print("image url: $image");
                chatController.setUserId(userId);
                chatController.setPage("support");
                chatController.setChatHeader(userController.userInfoModel.fName,image);
